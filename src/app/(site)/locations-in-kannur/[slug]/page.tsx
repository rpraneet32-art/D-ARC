    ...
    <main className="min-h-screen pt-24 pb-20">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto bg-white p-8 md:p-12 border border-gray-100 rounded-xl shadow-sm mt-8">
          ...
          {/* Section 2: Interior Design (H2 + H3) */}
          ...
          <section className="mb-16">
            ...
            <p className="text-brand-grey leading-relaxed mb-6">
              Our clients are ambitious, busy individuals who demand excellence without the daily hassle of micromanaging a construction site. We utilize advanced project management software to provide real-time updates, photographic progress reports, and financial tracking. When you choose our turnkey services, you are assigned a dedicated project manager who serves as your single point of contact throughout the entire lifecycle of the build in {location.name}.
            </p>
          </section>
          ...
          <section className="mb-16 bg-brand-black text-white p-8 md:p-12 rounded-2xl shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-white">Landscape Design</h3>
                <p className="text-gray-400 leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3 text-white">Vastu Consulting</h3>
                <p className="text-gray-400 leading-relaxed">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold text-brand-black mb-2 flex items-center gap-3">
                ...
                <p className="text-brand-grey leading-relaxed pl-11">
          ...
          <div className="bg-gray-50 p-10 rounded-2xl border border-gray-100 text-center">
            <h3 className="text-2xl font-serif text-brand-black mb-4">Ready to Transform Your Space in {location.name}?</h3>
