...
export const metadata: Metadata = {
  title: "Blog | Coming Soon | D-Arc Architectural Interior",
    ...
    <div className="min-h-screen bg-brand-black flex items-center justify-center pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="text-brand-grey text-xl md:text-2xl mb-12">
          We are currently writing and curating our latest thoughts on architecture, interior design, and construction trends. 
          Check back soon for insights from our experts.
        </p>
