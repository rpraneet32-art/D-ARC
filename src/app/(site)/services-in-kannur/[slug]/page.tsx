        ...
        <div className="max-w-4xl bg-white p-8 md:p-12 border border-gray-100 rounded-xl shadow-sm mt-6">
          ...
          <div className="mt-12 pt-8 border-t border-gray-100">
            ...
            <p className="mt-6 text-sm text-brand-grey">
              View our past work in our <Link href="/portfolio-in-kannur" className="text-brand-gold hover:underline">Portfolio</Link> or learn more <Link href="/about-us-in-kannur" className="text-brand-gold hover:underline">About Us</Link>.
            </p>
          </div>
          <ContentFreshness />
        </div>
